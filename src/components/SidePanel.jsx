...
async function searchLocation()  {
  const res = await fetch(`https://api.openweathermap.org/geo/1.0/direct?q=${locationInput}}&limit=10&appid=1dde84c245e7a1646cb1025dad917e7b`)
...
async function searchLocationNameByCoords(lat, lon) {
  const res = await fetch(`https://api.openweathermap.org/geo/1.0/reverse?lat=${lat}&lon=${lon}&limit=1&appid=1dde84c245e7a1646cb1025dad917e7b`)
  const data = await res.json();
